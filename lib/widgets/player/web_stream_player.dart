...
class _WebStreamPlayerState extends State<WebStreamPlayer> {
  ...
  Widget build(BuildContext context) {
    ...
    // Desktop Linux uses a stub plugin (no WPE). Use Android / Chrome for video.
    if (!kIsWeb && defaultTargetPlatform == TargetPlatform.linux) {
      return const _PlayerMessage(
        icon: Icons.desktop_windows_rounded,
        message:
            'Video player inafanya kazi kwenye Android, iOS na Chrome.\nJaribu: flutter run -d chrome',
      );
    }
