...
class AdminSidebar extends StatelessWidget {
  const AdminSidebar({
    ...
    this.adminEmail = 'jamboplus@gmail.com',
    this.compact = false,
  });
    ...
    return Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            right: BorderSide(color: AdminColors.border.withValues(alpha: 0.35)),
          ),
        ),
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [AdminColors.greenDark, AdminColors.green],
                      ),
                  ...
                  if (!compact) ...[
                    ...
                    Expanded(child: Text('JamboAd', style: AdminTheme.heading(18))),
                  ],
                ],
              ),
            ),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'Admin',
                                    style: AdminTheme.body(13, color: AdminColors.textPrimary),
                                  ),
                                  Text(
                                    adminEmail,
              ...
              Expanded(
                child: Text(
                  ...
                  style: AdminTheme.body(
                    13,
                    color: active ? AdminColors.textPrimary : fg,
                  ),
                ),
              ),
            ],
