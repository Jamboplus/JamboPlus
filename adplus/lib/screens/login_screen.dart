...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    setState(() {
      _submitting = false;
      if (!ok) {
        _error = context.read<AdminState>().authError ?? 'Barua pepe au nenosiri si sahihi';
      }
    });
  }
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                children: [
                  ...
                  Text('JamboAd', style: AdminTheme.heading(32)),
                  const SizedBox(height: 8),
                  Text(
                    'Admin ya JamboPlus',
                    style: AdminTheme.body(14, color: AdminColors.textHint),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: const InputDecoration(hintText: 'jamboplus@gmail.com'),
                        ),
